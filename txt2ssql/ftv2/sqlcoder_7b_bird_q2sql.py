...
class Config:
    MODEL_NAME = "defog/sqlcoder-7b-2"  # BIRD pre-trained model
    ...
    NUM_EPOCHS = 1  # Single epoch for thesis comparison
    WARMUP_RATIO = 0.1
    WEIGHT_DECAY = 0.01
    LORA_R = 16
    LORA_ALPHA = 32
...
def main():
    ...
    print("Training: 1 Epoch for Comparative Analysis")
    print("="*70)
    ...
    if config.WANDB_ENABLED:
        wandb.init(entity=config.WANDB_ENTITY, project=config.WANDB_PROJECT,
                  ...
                  tags=["bird-pretrained", "thesis-comparison", "1-epoch", "sqlcoder"])
