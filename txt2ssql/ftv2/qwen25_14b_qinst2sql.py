#!/usr/bin/env python3
"""
Qwen 2.5 14B - Question + Instruction to SQL Generator
Training script for second stage of two-stage architecture
"""
...
class Config:
    ...
    TARGET_REPO = "taherdoust/qwen25-14b-cim-qinst2sql"
...
def main():
    print("="*70)
    print("CIM QInst2SQL Training - Qwen 2.5 14B")
    print("="*70)
    ...
    output_dir = f"{config.CHECKPOINT_DIR}/qwen25-14b-r{config.LORA_R}-qinst2sql"
    ...
    if config.WANDB_ENABLED:
        wandb.init(
            ...
            name=f"qwen25-14b-r{config.LORA_R}-qinst2sql",
            config=vars(config)
        )
