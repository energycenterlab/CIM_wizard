...
var require_jsts_min = __commonJS({
  "node_modules/@turf/jsts/dist/jsts.min.js"(exports, module) {
    !(function(t, e) {
      ...
      function e(t2, e3, n2) {
        return e3 = u4(e3), (function(t3, e4) {
        ...
        })(t2, h() ? Reflect.construct(e3, n2 || [], u4(t2).constructor) : e3.apply(t2, n2));
      }
      function n(t2, e3) {
      ...
      function a(t2, e3) {
        ...
        if (!n2) {
          if (Array.isArray(t2) || (n2 = y2(t2)) || e3) {
            n2 && (t2 = n2);
      ...
      function o() {
        return o = "undefined" != typeof Reflect && Reflect.get ? Reflect.get.bind() : function(t2, e3, n2) {
          var i2 = (function(t3, e4) {
            for (; !{}.hasOwnProperty.call(t3, e4) && null !== (t3 = u4(t3)); ) ;
            return t3;
          })(t2, e3);
          if (i2) {
      ...
      function f(t2, e3, n2, i2) {
        var r2 = o(u4(1 & i2 ? t2.prototype : t2), e3, n2);
      ...
      var st = (function() {
        ...
        return s(t2, [{ key: "le", value: function(t3) {
          ...
          if (arguments[0] instanceof t2) {
            var e3, n2, i2, r2, s2 = arguments[0], a2 = null, o2 = null, u5 = null, l2 = null;
            return e3 = (i2 = this._hi / s2._hi) - (a2 = (u5 = t2.SPLIT * i2) - (a2 = u5 - i2)), l2 = a2 * (o2 = (l2 = t2.SPLIT * s2._hi) - (o2 = l2 - s2._hi)) - (r2 = i2 * s2._hi) + a2 * (n2 = s2._hi - o2) + e3 * o2 + e3 * n2, new t2(l2 = i2 + (u5 = (this._hi - r2 - l2 + this._lo - i2 * s2._lo) / s2._hi), i2 - l2 + u5);
          }
          if ("number" == typeof arguments[0]) {
            var h2 = arguments[0];
          ...
          if (1 === arguments.length) {
            ...
            var l2, h2, c2, f2, g2 = arguments[0], v3 = arguments[1], y3 = null, d2 = null, _2 = null;
            c2 = this._hi + g2, h2 = this._lo + v3, d2 = c2 - (_2 = c2 - this._hi), y3 = h2 - (f2 = h2 - this._lo);
            var p2 = (l2 = c2 + (_2 = (d2 = g2 - _2 + (this._hi - d2)) + h2)) + (_2 = (y3 = v3 - f2 + (this._lo - y3)) + (_2 + (c2 - l2))), m2 = _2 + (l2 - p2);
          ...
          var e3, n2, i2, r2, s2 = null, a2 = null, o2 = null, u5 = null;
          e3 = (i2 = 1 / this._hi) - (s2 = (o2 = t2.SPLIT * i2) - (s2 = o2 - i2)), a2 = (u5 = t2.SPLIT * this._hi) - this._hi;
          var l2 = i2 + (o2 = (1 - (r2 = i2 * this._hi) - (u5 = s2 * (a2 = u5 - a2) - r2 + s2 * (n2 = this._hi - a2) + e3 * a2 + e3 * n2) - i2 * this._lo) / this._hi);
          ...
          if (0 === y3) v3 = a2;
            ...
            var d2 = t2.TEN.pow(y3);
            v3 = a2.divide(d2);
          } else if (y3 < 0) {
            var _2 = t2.TEN.pow(-y3);
            v3 = a2.multiply(_2);
          }
      ...
      var lt = (function() {
        ...
        return s(t2, null, [{ key: "orientationIndex", value: function(e3, n2, i2) {
          ...
          if (r2 <= 1) return r2;
          var s2 = ut.valueOf(n2.x).selfAdd(-e3.x), a2 = ut.valueOf(n2.y).selfAdd(-e3.y), o2 = ut.valueOf(i2.x).selfAdd(-n2.x), u5 = ut.valueOf(i2.y).selfAdd(-n2.y);
      ...
      var ct = (function() {
        ...
        return s(t2, null, [{ key: "index", value: function(t3, e3, n2) {
          ...
          if (arguments[0] instanceof Array) {
            ...
            do {
              u5 = (u5 + 1) % n2;
            } while (e3[u5].equals2D(i2) && u5 !== r2);
            var l2 = e3[o2], h2 = e3[u5];
          ...
          if (rt(arguments[0], ht)) {
            ...
            for (var v3 = f2.getCoordinate(0), y3 = 0, d2 = 1; d2 <= g2; d2++) {
              var _2 = f2.getCoordinate(d2);
              _2.y > v3.y && (v3 = _2, y3 = d2);
            }
            var p2 = null, k2 = y3;
            do {
              (k2 -= 1) < 0 && (k2 = g2), p2 = f2.getCoordinate(k2);
            } while (p2.equals2D(v3) && k2 !== y3);
            var x3 = null, I2 = y3;
            do {
              I2 = (I2 + 1) % g2, x3 = f2.getCoordinate(I2);
            } while (x3.equals2D(v3) && I2 !== y3);
            if (p2.equals2D(v3) || x3.equals2D(v3) || p2.equals2D(x3)) return false;
            var E2 = t2.index(p2, v3, x3);
            return 0 === E2 ? p2.x > x3.x : E2 > 0;
          }
        } }]);
      })();
      ...
      var ft = (function() {
        ...
        return s((function t2() {
          ...
          var r2 = t2.x < e3.x ? t2.x : e3.x, s2 = t2.y < e3.y ? t2.y : e3.y, a2 = t2.x > e3.x ? t2.x : e3.x, o2 = t2.y > e3.y ? t2.y : e3.y, u5 = n2.x < i2.x ? n2.x : i2.x, l2 = n2.y < i2.y ? n2.y : i2.y, h2 = n2.x > i2.x ? n2.x : i2.x, c2 = n2.y > i2.y ? n2.y : i2.y, f2 = ((r2 > u5 ? r2 : u5) + (a2 < h2 ? a2 : h2)) / 2, g2 = ((s2 > l2 ? s2 : l2) + (o2 < c2 ? o2 : c2)) / 2, v3 = t2.x - f2, y3 = t2.y - g2, d2 = e3.x - f2, _2 = e3.y - g2, p2 = n2.x - f2, m2 = n2.y - g2, k2 = i2.x - f2, x3 = i2.y - g2, I2 = y3 - _2, E2 = d2 - v3, N2 = v3 * _2 - d2 * y3, T2 = m2 - x3, S2 = k2 - p2, L2 = p2 * x3 - k2 * m2, C3 = I2 * S2 - T2 * E2, R2 = (E2 * L2 - S2 * N2) / C3, w2 = (T2 * N2 - I2 * L2) / C3;
        ...
        return s(t2, null, [{ key: "segmentToSegment", value: function(e3, n2, i2, r2) {
          ...
          if (U.intersects(e3, n2, i2, r2)) {
            ...
            if (0 === a2) s2 = true;
              ...
              var o2 = (e3.y - i2.y) * (r2.x - i2.x) - (e3.x - i2.x) * (r2.y - i2.y), u5 = ((e3.y - i2.y) * (n2.x - e3.x) - (e3.x - i2.x) * (n2.y - e3.y)) / a2, l2 = o2 / a2;
      ...
      var Ct = (function() {
        ...
        return s((function t2() {
          ...
          if (1 === arguments.length) e3.sort((function(t3, e4) {
            ...
            var u5 = e3.slice(arguments[1], arguments[2]);
            u5.sort((function(e4, n3) {
              return t2[3].compare(e4, n3);
            }));
            var l2 = e3.slice(0, arguments[1]).concat(u5, e3.slice(arguments[2], e3.length));
            e3.splice(0, e3.length);
            var h2, c2 = a(l2);
            try {
      ...
      var Vt = (function(t2) {
        ...
        return l(i2, t2), s(i2, [{ key: "getCoordinate", value: function(t3) {
          ...
          if (2 === arguments.length) {
            ...
            var y3 = arguments[0], d2 = arguments[1], _2 = arguments[2], p2 = arguments[3], m2 = 1;
            _2 > p2 && (m2 = -1);
            for (var k2 = _2; k2 !== p2; k2 += m2) this.add(y3[k2], d2);
            return true;
          }
        ...
        return s(t2, [{ key: "getM", value: function(t3) {
          ...
          if (this._dimension = 3, this._measures = 0, this._coordinates = null, 1 === arguments.length) {
            ...
            if (Number.isInteger(arguments[2]) && arguments[0] instanceof Array && Number.isInteger(arguments[1])) {
              ...
              var v3 = arguments[0], y3 = arguments[1], d2 = arguments[2];
              this._coordinates = new Array(v3).fill(null), this._dimension = y3, this._measures = d2;
      ...
      var se = (function(t2) {
        ...
        return s(t2, [{ key: "createEmpty", value: function(t3) {
          ...
          var u5 = e3.iterator().next();
          if (e3.size() > 1) {
            if (u5 instanceof Dt) return this.createMultiPolygon(t2.toPolygonArray(e3));
            if (u5 instanceof wt) return this.createMultiLineString(t2.toLineStringArray(e3));
            if (u5 instanceof bt) return this.createMultiPoint(t2.toPointArray(e3));
      ...
      var ke = (function() {
        return s((function t2(e3) {
          ...
          else if (this.isNumeric_(e3) || "-" == e3) t2 = de2, i2 = this.readNumber_();
        ...
        return s((function t2(e3, i2) {
          ...
          if (this.match(ge)) {
            ...
            switch (s2) {
              ...
              case "LINESTRING":
                var u5 = this.parseLineStringText_().map(e3);
      ...
      var We = (function() {
        ...
        return s(t2, null, [{ key: "maxDistance", value: function(e3, n2, i2, r2, s2, a2, o2, u5) {
          var l2 = t2.distance(e3, n2, s2, a2);
          return l2 = Math.max(l2, t2.distance(e3, n2, o2, u5)), l2 = Math.max(l2, t2.distance(i2, r2, s2, a2)), l2 = Math.max(l2, t2.distance(i2, r2, o2, u5));
          ...
          var i2 = e3.getMinX(), r2 = e3.getMinY(), s2 = e3.getMaxX(), a2 = e3.getMaxY(), o2 = n2.getMinX(), u5 = n2.getMinY(), l2 = n2.getMaxX(), h2 = n2.getMaxY(), c2 = t2.maxDistance(i2, r2, i2, a2, o2, u5, o2, h2);
      ...
      var cn = (function() {
        ...
        return l(i2, t2), s(i2, [{ key: "createParentBoundablesFromVerticalSlices", value: function(t3, e3) {
          ...
          if (1 === arguments.length) {
            ...
            if (4 === arguments.length) {
              var v3 = arguments[2], y3 = arguments[3], d2 = new en(arguments[0], arguments[1]), _2 = new un(this.getRoot(), d2, v3);
              return this.nearestNeighbourK(_2, y3);
            }
          }
      ...
      var vn = (function() {
        ...
        return s((function t2() {
          ...
          if (!n2.equals2D(e3[0])) throw new D2("bad split edge start point at " + n2);
          var i2 = t2.get(t2.size() - 1).getCoordinates(), r2 = i2[i2.length - 1];
          if (!r2.equals2D(e3[e3.length - 1])) throw new D2("bad split edge end point at " + r2);
        } }], [{ key: "constructor_", value: function() {
      ...
      var Mn = (function() {
        ...
        return s(t2, [{ key: "addNextSegment", value: function(t3, e3) {
          ...
          var s2 = e3.x - t3.x, a2 = e3.y - t3.y, o2 = Math.atan2(a2, s2), u5 = n2.x - t3.x, l2 = n2.y - t3.y, h2 = Math.atan2(l2, u5);
          ...
          var r2 = e3 === $.LEFT ? 1 : -1, s2 = t3.p1.x - t3.p0.x, a2 = t3.p1.y - t3.p0.y, o2 = Math.sqrt(s2 * s2 + a2 * a2), u5 = r2 * n2 * s2 / o2, l2 = r2 * n2 * a2 / o2;
      ...
      var An = (function() {
        ...
        return s(t2, [{ key: "getOffsetCurve", value: function(t3, e3) {
          ...
          for (var u5 = o2 - 2; u5 >= 0; u5--) e3.addNextSegment(a2[u5], true);
        ...
        return s((function t2() {
          ...
          if (3 === arguments.length) {
            if (rt(arguments[2], nt) && arguments[0] instanceof X && arguments[1] instanceof Ke) for (var s2 = arguments[0], a2 = arguments[1], o2 = arguments[2], u5 = a2.getEdge().getCoordinates(), l2 = 0; l2 < u5.length - 1; l2++) {
              ...
              var y3 = v3.next();
              y3.isForward() && this.findStabbedSegments(f2, y3, g2);
            }
          }
      ...
      var Fn = (function(t2) {
        ...
        return s(t2, [{ key: "getY", value: function() {
          ...
          if (this.x = null, this.y = null, this.w = null, 0 === arguments.length) this.x = 0, this.y = 0, this.w = 1;
            ...
            var c2 = arguments[0], f2 = arguments[1], g2 = arguments[2], v3 = arguments[3], y3 = c2.y - f2.y, d2 = f2.x - c2.x, _2 = c2.x * f2.y - f2.x * c2.y, p2 = g2.y - v3.y, m2 = v3.x - g2.x, k2 = g2.x * v3.y - v3.x * g2.y;
        ...
        return s(t2, [{ key: "area", value: function() {
          ...
          var r2 = e3.x, s2 = e3.y, a2 = n2.x - r2, o2 = i2.x - r2, u5 = n2.y - s2, l2 = i2.y - s2, h2 = a2 * l2 - o2 * u5, c2 = t3.x - r2, f2 = t3.y - s2, g2 = (l2 * c2 - o2 * f2) / h2, v3 = (-u5 * c2 + a2 * f2) / h2;
          return e3.getZ() + g2 * (n2.getZ() - e3.getZ()) + v3 * (i2.getZ() - e3.getZ());
          ...
          var i2 = ut.valueOf(t3.x).subtract(n2.x), r2 = ut.valueOf(t3.y).subtract(n2.y), s2 = ut.valueOf(e3.x).subtract(n2.x), a2 = ut.valueOf(e3.y).subtract(n2.y), o2 = ut.determinant(i2, r2, s2, a2).multiply(2), u5 = i2.sqr().add(r2.sqr()), l2 = s2.sqr().add(a2.sqr()), h2 = ut.determinant(r2, u5, a2, l2), c2 = ut.determinant(i2, u5, s2, l2), f2 = ut.valueOf(n2.x).subtract(h2.divide(o2)).doubleValue(), g2 = ut.valueOf(n2.y).add(c2.divide(o2)).doubleValue();
          return new X(f2, g2);
        } }, { key: "isAcute", value: function(t3, e3, n2) {
          return !!bn.isAcute(t3, e3, n2) && (!!bn.isAcute(e3, n2, t3) && !!bn.isAcute(n2, t3, e3));
        } }, { key: "circumcentre", value: function(e3, n2, i2) {
          var r2 = i2.x, s2 = i2.y, a2 = e3.x - r2, o2 = e3.y - s2, u5 = n2.x - r2, l2 = n2.y - s2, h2 = 2 * t2.det(a2, o2, u5, l2), c2 = t2.det(o2, a2 * a2 + o2 * o2, l2, u5 * u5 + l2 * l2), f2 = t2.det(a2, a2 * a2 + o2 * o2, u5, u5 * u5 + l2 * l2);
          ...
          var i2 = e3.x - t3.x, r2 = e3.y - t3.y, s2 = e3.getZ() - t3.getZ(), a2 = n2.x - t3.x, o2 = n2.y - t3.y, u5 = n2.getZ() - t3.getZ(), l2 = r2 * u5 - s2 * o2, h2 = s2 * a2 - i2 * u5, c2 = i2 * o2 - r2 * a2, f2 = l2 * l2 + h2 * h2 + c2 * c2, g2 = Math.sqrt(f2) / 2;
          return g2;
        } }, { key: "centroid", value: function(t3, e3, n2) {
          var i2 = (t3.x + e3.x + n2.x) / 3, r2 = (t3.y + e3.y + n2.y) / 3;
          return new X(i2, r2);
        } }, { key: "inCentre", value: function(t3, e3, n2) {
          var i2 = e3.distance(n2), r2 = t3.distance(n2), s2 = t3.distance(e3), a2 = i2 + r2 + s2, o2 = (i2 * t3.x + r2 * e3.x + s2 * n2.x) / a2, u5 = (i2 * t3.y + r2 * e3.y + s2 * n2.y) / a2;
          return new X(o2, u5);
        } }]);
      })(), Yn = (function() {
        return s((function t2() {
        ...
        return s(t2, [{ key: "compareTo", value: function(e3) {
          ...
          for (var r2 = e3 ? 1 : -1, s2 = i2 ? 1 : -1, a2 = e3 ? t3.length : -1, o2 = i2 ? n2.length : -1, u5 = e3 ? 0 : t3.length - 1, l2 = i2 ? 0 : n2.length - 1; ; ) {
      ...
      var ri = (function(t2) {
        ...
        return s(t2, [{ key: "checkEndPtVertexIntersections", value: function() {
          ...
          if (0 === arguments.length) for (var t3 = this._segStrings.iterator(); t3.hasNext(); ) for (var e3 = t3.next(), n2 = this._segStrings.iterator(); n2.hasNext(); ) {
            ...
            var v3 = h2.getCoordinates()[c2], y3 = h2.getCoordinates()[c2 + 1], d2 = f2.getCoordinates()[g2], _2 = f2.getCoordinates()[g2 + 1];
            if (this._li.computeIntersection(v3, y3, d2, _2), this._li.hasIntersection() && (this._li.isProper() || this.hasInteriorIntersection(this._li, v3, y3) || this.hasInteriorIntersection(this._li, d2, _2))) throw new D2("found non-noded intersection at " + v3 + "-" + y3 + " and " + d2 + "-" + _2);
          }
          ...
          if (e3.equals(i2)) throw new D2("found non-noded collapse at " + t2.fact.createLineString([e3, n2, i2]));
        } }], [{ key: "constructor_", value: function() {
...
var init_tinyqueue = __esm({
  "node_modules/tinyqueue/index.js"() {
    TinyQueue2 = class {
      constructor(data = [], compare2 = defaultCompare3) {
        this.data = data;
...
function destination(origin, distance2, bearing2, options = {}) {
  ...
  if (coordinates1[2] !== void 0) {
    return point([lng, lat2, coordinates1[2]], options.properties);
  }
...
// node_modules/@turf/rhumb-bearing/dist/esm/index.js
...
function angle(startPoint, midPoint, endPoint, options = {}) {
  ...
  let azimuthOB = bearingToAzimuth(
    options.mercator !== true ? bearing(O, B3) : rhumbBearing(O, B3)
  );
...
function polygonclip(points2, bbox3) {
  ...
  for (edge = 1; edge <= 8; edge *= 2) {
    ...
    for (i = 0; i < points2.length; i++) {
      ...
      if (inside !== prevInside) result.push(intersect(prev, p, edge, bbox3));
...
// node_modules/@turf/bezier-spline/dist/esm/index.js
var Spline = class {
  constructor(options) {
...
// node_modules/@turf/boolean-concave/dist/esm/index.js
function booleanConcave(polygon2) {
  ...
  for (let i = 0; i < n; i++) {
    ...
    if (i === 0) {
      sign2 = zcrossproduct > 0;
    } else if (sign2 !== zcrossproduct > 0) {
      return true;
    }
  }
  return false;
...
var TinyQueue = class {
  constructor(data = [], compare2 = defaultCompare2) {
    this.data = data;
    this.length = this.data.length;
    this.compare = compare2;
    if (this.length > 0) {
  ...
  while (eventQueue.length) {
    ...
    if (event.isLeftEndpoint) {
      ...
      for (let i = 0; i < outQueue.data.length; i++) {
        ...
        const intersection4 = testSegmentIntersect(segment, otherSeg);
        if (intersection4 !== false) intersectionPoints.push(intersection4);
      }
...
function lineIntersect(line1, line2, options = {}) {
  const { removeDuplicates: removeDuplicates2 = true, ignoreSelfIntersections = true } = options;
  let features = [];
  ...
  if (removeDuplicates2) {
    const unique = {};
    intersections.forEach((intersection4) => {
      const key = intersection4.join(",");
      if (!unique[key]) {
        unique[key] = true;
        results.push(intersection4);
      }
    });
  } else {
...
function lngLatToVector(a) {
  const lat2 = degreesToRadians(a[1]);
...
function nearestPointOnSegment(posA, posB, posC) {
  ...
  const cmpIB = dot(cross(I, B3), segmentAxisNorm);
  if (cmpAI >= 0 && cmpIB >= 0) {
...
// node_modules/@turf/boolean-contains/dist/esm/index.js
...
function isMultiPolyInPoly(polygon2, multiPolygon2) {
  return multiPolygon2.coordinates.every(
    (coords) => isPolyInPoly(polygon2, { type: "Polygon", coordinates: coords })
  );
}
...
function cleanLine(line, type) {
  const points2 = getCoords(line);
  if (points2.length === 2 && !equals(points2[0], points2[1])) return points2;
  const newPoints = [];
  let a = 0, b = 1, c = 2;
  newPoints.push(points2[a]);
  while (c < points2.length) {
    if (booleanPointOnLine(points2[b], lineString([points2[a], points2[c]]))) {
      b = c;
    } else {
      newPoints.push(points2[b]);
      a = b;
      b++;
      c = b;
    }
...
// node_modules/@turf/boolean-crosses/dist/esm/index.js
...
// node_modules/@turf/line-overlap/dist/esm/index.js
...
// node_modules/@turf/boolean-overlap/dist/esm/index.js
...
// node_modules/@turf/boolean-parallel/dist/esm/index.js
...
// node_modules/@turf/boolean-touches/dist/esm/index.js
...
function isPointOnLineEnd(point2, line) {
  if (compareCoords3(line.coordinates[0], point2.coordinates)) return true;
  if (compareCoords3(
...
// node_modules/@turf/boolean-valid/dist/esm/index.js
function booleanValid(feature2) {
  if (!feature2.type) return false;
  const geom = getGeom(feature2);
  const type = geom.type;
  const coords = geom.coordinates;
  switch (type) {
...
function checkRingsForSpikesPunctures(geom) {
  for (var i = 0; i < geom.length - 1; i++) {
    ...
    for (var ii = i + 1; ii < geom.length - 2; ii++) {
      ...
      if (booleanPointOnLine(point2, lineString(seg))) return true;
    }
  }
  return false;
}
...
function splitLineIntoSegmentsOnPolygon2(linestring, polygon2) {
  const coords = linestring.coordinates;
  const outputSegments = [];
  for (let i = 0; i < coords.length - 1; i++) {
    const seg = lineString([coords[i], coords[i + 1]]);
...
function isLineInPoly3(linestring, polygon2) {
  ...
  let isContainedByPolygonBoundary = false;
  const lineSegments = splitLineIntoSegmentsOnPolygon2(linestring, polygon2);
  for (const lineSegment2 of lineSegments.features) {
    const midpoint2 = getMidpoint2(
      lineSegment2.geometry.coordinates[0],
      lineSegment2.geometry.coordinates[1]
    );
    if (!booleanPointInPolygon(midpoint2, polygon2)) {
...
function polygonContains_default(polygon2, point2) {
  ...
  return (angle2 < -epsilon2 || angle2 < epsilon2 && sum2 < -epsilon2) ^ winding & 1;
}
  ...
  return {
    ...
    point: function(lambda1, phi1) {
      ...
      if (abs(delta - pi) < epsilon2) {
        ...
        if (abs(lambda0 - sign0) < epsilon2) lambda0 -= sign0 * epsilon2;
        if (abs(lambda1 - sign1) < epsilon2) lambda1 -= sign1 * epsilon2;
...
function clipAntimeridianIntersect(lambda0, phi0, lambda1, phi1) {
  ...
  return abs(sinLambda0Lambda1) > epsilon2 ? atan((sin(phi0) * (cosPhi1 = cos(phi1)) * sin(lambda1) - sin(phi1) * (cosPhi0 = cos(phi0)) * sin(lambda0)) / (cosPhi0 * cosPhi1 * sinLambda0Lambda1)) : (phi0 + phi1) / 2;
}
...
function circle_default(radius, delta) {
  var cr = cos(radius), smallRadius = cr > 0, notHemisphere = abs(cr) > epsilon2;
  function interpolate2(from, to, direction, stream) {
  ...
  function intersect4(a, b, two) {
    ...
    var delta2 = lambda1 - lambda0, polar = abs(delta2 - pi) < epsilon2, meridian = polar || delta2 < epsilon2;
    if (!polar && phi1 < phi0) z = phi0, phi0 = phi1, phi1 = z;
    if (meridian ? polar ? phi0 + phi1 > 0 ^ q[1] < (abs(q[0] - lambda0) < epsilon2 ? phi0 : phi1) : phi0 <= q[1] && q[1] <= phi1 : delta2 > pi ^ (lambda0 <= q[0] && q[0] <= lambda1)) {
...
function resample(project, delta2) {
  function resampleLineTo(x02, y02, lambda0, a0, b0, c0, x12, y12, lambda1, a1, b1, c1, depth, stream) {
    ...
    if (d2 > 4 * delta2 && depth--) {
      var a = a0 + a1, b = b0 + b1, c = c0 + c1, m = sqrt(a * a + b * b + c * c), phi2 = asin(c /= m), lambda2 = abs(abs(c) - 1) < epsilon2 || abs(lambda0 - lambda1) < epsilon2 ? (lambda0 + lambda1) / 2 : atan2(b, a), p = project(lambda2, phi2), x2 = p[0], y2 = p[1], dx2 = x2 - x02, dy2 = y2 - y02, dz = dy * dx2 - dx * dy2;
...
// node_modules/@turf/center-mean/dist/esm/index.js
...
// node_modules/@turf/center-median/dist/esm/index.js
function centerMedian(features, options = {}) {
  ...
  featureEach(features, function(feature2) {
    ...
    centroids.features.push(
      centroid(feature2, {
        properties: { weight: (_a2 = feature2.properties) == null ? void 0 : _a2[weightTerm] }
      })
    );
  });
  const properties = {
...
function findMedian(candidateMedian, previousCandidate, centroids, properties, counter) {
  ...
  featureEach(centroids, function(theCentroid) {
    var _a2;
    var weightValue = (_a2 = theCentroid.properties) == null ? void 0 : _a2.weight;
...
// node_modules/@turf/center-of-mass/dist/esm/index.js
...
// node_modules/@turf/clusters/dist/esm/index.js
var esm_exports5 = {};
...
function getCluster(geojson, filter) {
  ...
  var features = [];
  featureEach(geojson, function(feature2) {
    if (applyFilter(feature2.properties, filter)) features.push(feature2);
  });
  return featureCollection(features);
}
...
init_tinyqueue();
var earthRadius2 = 6371;
var rad = Math.PI / 180;
function around(index, lng, lat2, maxResults = Infinity, maxDistance = Infinity, predicate) {
  let maxHaverSinDist = 1;
  const result = [];
  if (maxResults === void 0) maxResults = Infinity;
  if (maxDistance !== void 0) maxHaverSinDist = haverSin(maxDistance / earthRadius2);
  const q = new TinyQueue2([], compareDist);
  let node = {
    left: 0,
  ...
  const cosLat = Math.cos(lat2 * rad);
  while (node) {
    ...
    if (right - left <= index.nodeSize) {
      for (let i = left; i <= right; i++) {
        ...
        if (!predicate || predicate(id)) {
          const dist = haverSinDist(lng, lat2, index.coords[2 * i], index.coords[2 * i + 1], cosLat);
          q.push({ id, dist });
        }
      }
    } else {
      ...
      if (!predicate || predicate(id)) {
        const dist = haverSinDist(lng, lat2, midLng, midLat, cosLat);
        q.push({ id, dist });
      }
      ...
      leftNode.dist = boxDist(lng, lat2, cosLat, leftNode);
      rightNode.dist = boxDist(lng, lat2, cosLat, rightNode);
      q.push(leftNode);
      q.push(rightNode);
    }
...
function boxDist(lng, lat2, cosLat, node) {
  const minLng = node.minLng;
  const maxLng = node.maxLng;
  const minLat = node.minLat;
  const maxLat = node.maxLat;
  if (lng >= minLng && lng <= maxLng) {
    if (lat2 < minLat) return haverSin((lat2 - minLat) * rad);
    if (lat2 > maxLat) return haverSin((lat2 - maxLat) * rad);
    return 0;
  }
  const haverSinDLng = Math.min(haverSin((lng - minLng) * rad), haverSin((lng - maxLng) * rad));
  const extremumLat = vertexLat(lat2, haverSinDLng);
  if (extremumLat > minLat && extremumLat < maxLat) {
    return haverSinDistPartial(haverSinDLng, cosLat, lat2, extremumLat);
  }
  return Math.min(
    haverSinDistPartial(haverSinDLng, cosLat, lat2, minLat),
    haverSinDistPartial(haverSinDLng, cosLat, lat2, maxLat)
  );
}
...
function vertexLat(lat2, haverSinDLng) {
  const cosDLng = 1 - 2 * haverSinDLng;
  if (cosDLng <= 0) return lat2 > 0 ? 90 : -90;
  return Math.atan(Math.tan(lat2 * rad) / cosDLng) / rad;
}

// node_modules/@turf/clusters-dbscan/dist/esm/index.js
function clustersDbscan(points2, maxDistance, options = {}) {
  if (options.mutate !== true) points2 = clone(points2);
  const minPoints = options.minPoints || 3;
  const kdIndex = new KDBush(points2.features.length);
  for (const point2 of points2.features) {
    kdIndex.add(point2.geometry.coordinates[0], point2.geometry.coordinates[1]);
  }
  kdIndex.finish();
  ...
  const regionQuery = (index) => {
    const point2 = points2.features[index];
    const [x2, y2] = point2.geometry.coordinates;
    return around(kdIndex, x2, y2, void 0, maxDistance).map((id) => ({
      minX: points2.features[id].geometry.coordinates[0],
      minY: points2.features[id].geometry.coordinates[1],
      maxX: points2.features[id].geometry.coordinates[0],
      maxY: points2.features[id].geometry.coordinates[1],
      index: id
    }));
  };
  ...
  points2.features.forEach((_, index) => {
  ...
  points2.features.forEach((_, index) => {
    var clusterPoint = points2.features[index];
...
// node_modules/@turf/clusters-kmeans/dist/esm/index.js
...
function clustersKmeans(points2, options = {}) {
  ...
  featureEach(points2, function(point2, index) {
...
// node_modules/@turf/collect/dist/esm/index.js
function collect(polygons2, points2, inProperty, outProperty) {
  ...
  var treeItems = points2.features.map(function(item) {
    ...
    return {
      ...
      property: (_a2 = item.properties) == null ? void 0 : _a2[inProperty]
    };
  });
...
// node_modules/@turf/combine/dist/esm/index.js
function combine(fc) {
  var groups = {
    MultiPoint: {
      coordinates: [],
  ...
  featureEach(fc, (feature2) => {
    var _a2;
    switch ((_a2 = feature2.geometry) == null ? void 0 : _a2.type) {
      case "Point":
...
// node_modules/@turf/tin/dist/esm/index.js
...
function hashset_default(size, hash, equal3, type, empty) {
  ...
  function add3(value) {
    var index = hash(value) & mask2, match = store[index], collisions = 0;
    while (match != empty) {
      if (equal3(match, value)) return true;
      if (++collisions >= size) throw new Error("full hashset");
      match = store[index = index + 1 & mask2];
    }
    store[index] = value;
    return true;
  }
...
function hashmap_default(size, hash, equal3, keyType, keyEmpty, valueType) {
  ...
  function set2(key, value) {
    var index = hash(key) & mask2, matchKey = keystore[index], collisions = 0;
    while (matchKey != keyEmpty) {
      if (equal3(matchKey, key)) return valstore[index] = value;
      if (++collisions >= size) throw new Error("full hashmap");
      matchKey = keystore[index = index + 1 & mask2];
    }
    keystore[index] = key;
  ...
  function maybeSet(key, value) {
    var index = hash(key) & mask2, matchKey = keystore[index], collisions = 0;
    while (matchKey != keyEmpty) {
      if (equal3(matchKey, key)) return valstore[index];
      if (++collisions >= size) throw new Error("full hashmap");
      matchKey = keystore[index = index + 1 & mask2];
    }
    keystore[index] = key;
...
// node_modules/@turf/concave/dist/esm/index.js
...
function clone2(configObject) {
  ...
  function BigNumber2(v2, b) {
    ...
    if (!(x2 instanceof BigNumber2)) return new BigNumber2(v2, b);
    if (b == null) {
      ...
      if (isNum = typeof v2 == "number") {
        if (v2 * 0 != 0) return parseNumeric(x2, str, isNum, b);
      ...
      for (len = str.length; i < len; i++) {
        if (alphabet.indexOf(c = str.charAt(i)) < 0) {
          ...
          return parseNumeric(x2, String(v2), isNum, b);
        }
      }
      isNum = false;
  ...
  convertBase = /* @__PURE__ */ (function() {
    ...
    return function(str, baseIn, baseOut, sign2, callerIsToString) {
      var alphabet, d, e, k, r, x2, xc, y2, i = str.indexOf("."), dp = DECIMAL_PLACES, rm = ROUNDING_MODE;
      if (i >= 0) {
        k = POW_PRECISION;
        POW_PRECISION = 0;
        str = str.replace(".", "");
  ...
  div = /* @__PURE__ */ (function() {
    function multiply(x2, k, base) {
      var m, temp2, xlo, xhi, carry = 0, i = x2.length, klo = k % SQRT_BASE, khi = k / SQRT_BASE | 0;
      for (x2 = x2.slice(); i--; ) {
        xlo = x2[i] % SQRT_BASE;
    ...
    return function(x2, y2, dp, rm, base) {
      var cmp, e, i, more, n, prod, prodL, q, qc, rem, remL, rem0, xi, xL, yc0, yL, yz, s = x2.s == y2.s ? 1 : -1, xc = x2.c, yc = y2.c;
      if (!xc || !xc[0] || !yc || !yc[0]) {
  ...
  function maxOrMin(args, n) {
    var k, y2, i = 1, x2 = new BigNumber2(args[0]);
    for (; i < args.length; i++) {
      y2 = new BigNumber2(args[i]);
      if (!y2.s || (k = compare(x2, y2)) === n || k === 0 && x2.s === n) {
        x2 = y2;
      }
    }
    return x2;
  ...
  function round2(x2, sd, rm, r) {
    var d, i, j, k, n, ni, rd, xc = x2.c, pows10 = POWS_TEN;
    if (xc) {
      out: {
  ...
  P.exponentiatedBy = P.pow = function(n, m) {
    var half, isModExp, i, k, more, nIsBig, nIsNeg, nIsOdd, y2, x2 = this;
    n = new BigNumber2(n);
    if (n.c && !n.isInteger()) {
    ...
    return m ? y2.mod(m) : k ? round2(y2, POW_PRECISION, ROUNDING_MODE, more) : y2;
  };
  ...
  P.multipliedBy = P.times = function(y2, b) {
    var c, e, i, j, k, m, xcL, xlo, xhi, ycL, ylo, yhi, zc, base, sqrtBase, x2 = this, xc = x2.c, yc = (y2 = new BigNumber2(y2, b)).c;
    if (!xc || !yc || !xc[0] || !yc[0]) {
  ...
  P.toFraction = function(md) {
    var d, d0, d1, d2, e, exp2, n, n0, n1, q, r, s, x2 = this, xc = x2.c;
    if (md != null) {
      n = new BigNumber2(md);
...
function compare(x2, y2) {
  var a, b, xc = x2.c, yc = y2.c, i = x2.s, j = y2.s, k = x2.e, l = y2.e;
  if (!i || !j) return null;
  a = xc && !xc[0];
  b = yc && !yc[0];
...
var SplayTreeSet = class _SplayTreeSet extends SplayTree {
  ...
  retainAll(elements) {
    ...
    for (const object2 of elements) {
      if (modificationCount != this.modificationCount) {
        throw "Concurrent modification during iteration.";
      }
      if (this.validKey(object2) && this.splay(object2) == 0) {
  ...
  lookup(object2) {
    if (!this.validKey(object2)) return null;
    const comp = this.splay(object2);
    if (comp != 0) return null;
    return this.root.key;
  }
  intersection(other) {
...
// node_modules/polyclip-ts/dist/esm/index.js
var constant_default3 = (x2) => {
  return () => {
    return x2;
  };
};
var compare_default = (eps) => {
  const almostEqual = eps ? (a, b) => b.minus(a).abs().isLessThanOrEqualTo(eps) : constant_default3(false);
  return (a, b) => {
...
var horizontalIntersection = (pt, v2, y2) => {
  ...
  return { x: pt.x.plus(v2.x.div(v2.y).times(y2.minus(pt.y))), y: y2 };
};
var verticalIntersection = (pt, v2, x2) => {
  if (v2.x.isZero()) return null;
  return { x: x2, y: pt.y.plus(v2.y.div(v2.x).times(x2.minus(pt.x))) };
};
...
var RingOut = class _RingOut {
  ...
  getGeom() {
    ...
    if (precision.orient(pt, prevPt, nextPt) === 0) points2.shift();
    ...
    for (let i = iStart; i != iEnd; i += step)
      orderedPoints.push([points2[i].x.toNumber(), points2[i].y.toNumber()]);
...
// node_modules/@turf/difference/dist/esm/index.js
...
// node_modules/@turf/distance-weight/dist/esm/index.js
...
function distanceWeight(fc, options) {
  ...
  const p = options.p || 2;
  const binary = (_a2 = options.binary) != null ? _a2 : false;
  const alpha = options.alpha || -1;
  const rowTransform = (_b2 = options.standardization) != null ? _b2 : false;
  const features = [];
  featureEach(fc, (feature2) => {
...
// node_modules/@turf/rhumb-distance/dist/esm/index.js
...
// node_modules/@turf/transform-rotate/dist/esm/index.js
...
function ellipse(center2, xSemiAxis, ySemiAxis, options) {
  ...
  if (!isNumber(angle2)) throw new Error("angle must be a number");
  const centerCoords = getCoord(
    transformRotate(point(getCoord(center2)), angle2, { pivot })
  );
  angle2 = -90 + angle2;
  ...
  for (let i = 0; i < steps; i++) {
    ...
    if (m === 0) {
      ...
      w = (-(m * x2 + c) + Math.sqrt(Math.pow(m * x2 + c, 2) - 4 * (v2 * m) * -(A / k))) / (2 * (v2 * m));
    }
    if (x2 != 0) {
      quadrantParameters.push(x2);
    }
  }
  parameters.push(0);
  ...
  for (const param of parameters) {
    ...
    coords.push(
      destination(centerCoords, r, angle2 + radiansToDegrees(theta), {
        units
...
// node_modules/@turf/envelope/dist/esm/index.js
...
// node_modules/@turf/flip/dist/esm/index.js
function flip(geojson, options) {
  var _a2;
  options = options || {};
  if (!isObject(options)) throw new Error("options is invalid");
  const mutate = (_a2 = options.mutate) != null ? _a2 : false;
  if (!geojson) throw new Error("geojson is required");
  if (mutate === false || mutate === void 0) geojson = clone(geojson);
  coordEach(geojson, function(coord) {
    var x2 = coord[0];
...
// node_modules/arc/dist/esm/utils.js
...
// node_modules/arc/dist/esm/coord.js
var Coord = class _Coord {
  constructor(lon2, lat2) {
...
// node_modules/arc/dist/esm/arc.js
var Arc = class {
  ...
  wkt() {
    ...
    let wktParts = [];
    for (const geometry2 of this.geometries) {
      if (!geometry2 || geometry2.coords.length === 0) {
        wktParts.push("LINESTRING EMPTY");
        continue;
      }
      const coordStrings = geometry2.coords.filter((coord) => coord !== void 0).map((coord) => {
        const lon2 = coord[0] ?? 0;
        const lat2 = coord[1] ?? 0;
        return `${lon2} ${lat2}`;
      });
...
// node_modules/arc/dist/esm/line-string.js
...
// node_modules/arc/dist/esm/great-circle.js
var GreatCircle = class {
  ...
  interpolate(f) {
    ...
    const B3 = Math.sin(f * this.g) / Math.sin(this.g);
    const x2 = A * Math.cos(this.start.y) * Math.cos(this.start.x) + B3 * Math.cos(this.end.y) * Math.cos(this.end.x);
    const y2 = A * Math.cos(this.start.y) * Math.sin(this.start.x) + B3 * Math.cos(this.end.y) * Math.sin(this.end.x);
    const z = A * Math.sin(this.start.y) + B3 * Math.sin(this.end.y);
    const lat2 = R2D * Math.atan2(z, Math.sqrt(Math.pow(x2, 2) + Math.pow(y2, 2)));
    const lon2 = R2D * Math.atan2(y2, x2);
    return [lon2, lat2];
  }
  /**
  ...
  Arc(npoints, options) {
    ...
    if (!npoints || npoints <= 2) {
      ...
      for (let i = 0; i < npoints; ++i) {
        const step = delta * i;
        const pair2 = this.interpolate(step);
        first_pass.push(pair2);
      }
    }
    let bHasBigDiff = false;
    let dfMaxSmallDiffLong = 0;
    const dfDateLineOffset = (options == null ? void 0 : options.offset) ?? 10;
    ...
    for (let j = 1; j < first_pass.length; ++j) {
      const dfPrevX = ((_a2 = first_pass[j - 1]) == null ? void 0 : _a2[0]) ?? 0;
      const dfX = ((_b2 = first_pass[j]) == null ? void 0 : _b2[0]) ?? 0;
    ...
    if (bHasBigDiff && dfMaxSmallDiffLong < dfDateLineOffset) {
      ...
      for (let k = 0; k < first_pass.length; ++k) {
        const dfX0 = parseFloat((((_c = first_pass[k]) == null ? void 0 : _c[0]) ?? 0).toString());
        if (k > 0 && Math.abs(dfX0 - (((_d = first_pass[k - 1]) == null ? void 0 : _d[0]) ?? 0)) > dfDiffSpace) {
          const dfX1 = parseFloat((((_e = first_pass[k - 1]) == null ? void 0 : _e[0]) ?? 0).toString());
          const dfY1 = parseFloat((((_f = first_pass[k - 1]) == null ? void 0 : _f[1]) ?? 0).toString());
          const dfX2 = parseFloat((((_g = first_pass[k]) == null ? void 0 : _g[0]) ?? 0).toString());
          const dfY2 = parseFloat((((_h = first_pass[k]) == null ? void 0 : _h[1]) ?? 0).toString());
          if (dfX1 > -180 && dfX1 < dfRightBorderX && dfX2 === 180 && k + 1 < first_pass.length && (((_i = first_pass[k - 1]) == null ? void 0 : _i[0]) ?? 0) > -180 && (((_j = first_pass[k - 1]) == null ? void 0 : _j[0]) ?? 0) < dfRightBorderX) {
            poNewLS.push([-180, ((_k = first_pass[k]) == null ? void 0 : _k[1]) ?? 0]);
            k++;
            poNewLS.push([((_l = first_pass[k]) == null ? void 0 : _l[0]) ?? 0, ((_m = first_pass[k]) == null ? void 0 : _m[1]) ?? 0]);
            continue;
          } else if (dfX1 > dfLeftBorderX && dfX1 < 180 && dfX2 === -180 && k + 1 < first_pass.length && (((_n = first_pass[k - 1]) == null ? void 0 : _n[0]) ?? 0) > dfLeftBorderX && (((_o = first_pass[k - 1]) == null ? void 0 : _o[0]) ?? 0) < 180) {
            poNewLS.push([180, ((_p = first_pass[k]) == null ? void 0 : _p[1]) ?? 0]);
            k++;
            poNewLS.push([((_q = first_pass[k]) == null ? void 0 : _q[0]) ?? 0, ((_r = first_pass[k]) == null ? void 0 : _r[1]) ?? 0]);
            continue;
          }
          ...
          if (dfX1 <= 180 && dfX2 >= 180 && dfX1 < dfX2) {
            ...
            poNewLS.push([(((_s = first_pass[k - 1]) == null ? void 0 : _s[0]) ?? 0) > dfLeftBorderX ? 180 : -180, dfY]);
            poNewLS = [];
            poNewLS.push([(((_t = first_pass[k - 1]) == null ? void 0 : _t[0]) ?? 0) > dfLeftBorderX ? -180 : 180, dfY]);
            poMulti.push(poNewLS);
          } else {
            poNewLS = [];
            poMulti.push(poNewLS);
          }
          poNewLS.push([dfX0, ((_u = first_pass[k]) == null ? void 0 : _u[1]) ?? 0]);
        } else {
          poNewLS.push([((_v = first_pass[k]) == null ? void 0 : _v[0]) ?? 0, ((_w = first_pass[k]) == null ? void 0 : _w[1]) ?? 0]);
        }
      }
    } else {
      const poNewLS0 = [];
      ...
      for (let l = 0; l < first_pass.length; ++l) {
        poNewLS0.push([((_x = first_pass[l]) == null ? void 0 : _x[0]) ?? 0, ((_y = first_pass[l]) == null ? void 0 : _y[1]) ?? 0]);
      }
    }
    ...
    for (let m = 0; m < poMulti.length; ++m) {
      ...
      const points2 = poMulti[m];
      if (points2) {
        for (let j0 = 0; j0 < points2.length; ++j0) {
          const point2 = points2[j0];
          if (point2) {
            line.move_to(roundCoords([point2[0], point2[1]]));
          }
        }
      }
    }
...
// node_modules/@turf/great-circle/dist/esm/index.js
...
// node_modules/@turf/hex-grid/dist/esm/index.js
function hexGrid(bbox3, cellSide, options = {}) {
  ...
  for (let x2 = 0; x2 <= x_count; x2++) {
    for (let y2 = 0; y2 <= y_count; y2++) {
      const isOdd2 = x2 % 2 === 1;
      if (y2 === 0 && isOdd2) continue;
      if (y2 === 0 && hasOffsetY) continue;
...
// node_modules/@turf/point-grid/dist/esm/index.js
...
// node_modules/@turf/rectangle-grid/dist/esm/index.js
...
// node_modules/@turf/square-grid/dist/esm/index.js
function squareGrid(bbox3, cellSide, options = {}) {
  return rectangleGrid(bbox3, cellSide, cellSide, options);
}

// node_modules/@turf/triangle-grid/dist/esm/index.js
...
// node_modules/@turf/interpolate/dist/esm/index.js
function interpolate(points2, cellSize, options) {
  ...
  var gridType = (_a2 = options.gridType) != null ? _a2 : "square";
  var property = (_b2 = options.property) != null ? _b2 : "elevation";
  var weight = (_c = options.weight) != null ? _c : 1;
  var box = (_d = options.bbox) != null ? _d : bbox(points2);
  ...
  featureEach(grid, function(gridFeature) {
    ...
    featureEach(points2, function(point2) {
      ...
      var zValue;
      if (property !== void 0) {
        zValue = (_a3 = point2.properties) == null ? void 0 : _a3[property];
      }
      if (zValue === void 0) {
    ...
    (_a22 = newFeature.properties) != null ? _a22 : newFeature.properties = {};
...
// node_modules/@turf/isobands/dist/esm/index.js
...
function gridToMatrix(grid, options = {}) {
  if (!isObject(options)) throw new Error("options is invalid");
  const { zProperty = "elevation", flip: flip2 = false, flags = false } = options;
  ...
  for (var r = 0; r < pointsMatrix.length; r++) {
    ...
    for (var c = 0; c < pointRow.length; c++) {
      ...
      if (point2.properties == null) {
        point2.properties = {};
      }
      if (point2.properties[zProperty]) row.push(point2.properties[zProperty]);
      else row.push(0);
      if (flags === true) point2.properties.matrixPosition = [r, c];
    }
    matrix.push(row);
  }
  return matrix;
...
function sortPointsByLatLng(points2, flip2) {
  ...
  pointMatrix.sort(
    flip2 ? (a, b) => getCoords(a[0])[1] - getCoords(b[0])[1] : (a, b) => getCoords(b[0])[1] - getCoords(a[0])[1]
  );
  return pointMatrix;
}
function isobands(pointGrid2, breaks, options) {
  ...
  const multipolygons = contours.map((contour, index) => {
    ...
    const contourProperties = __spreadValues2(__spreadValues2({}, commonProperties), breaksProperties[index]);
...
function createContourLines(matrix, breaks, property) {
  ...
  for (let i = 1; i < breaks.length; i++) {
    ...
    const polygons2 = groupNestedRings(orderedRings);
    if (polygons2.length === 0 && matrix[0][0] < upperBand && matrix[0][0] >= lowerBand) {
      const dx = matrix[0].length;
...
function getSegments(matrix, threshold) {
  ...
  const dx = matrix[0].length;
  const dy = matrix.length;
  for (let y2 = 0; y2 < dy - 1; y2++) {
    for (let x2 = 0; x2 < dx - 1; x2++) {
      const tr = matrix[y2 + 1][x2 + 1];
      const br = matrix[y2][x2 + 1];
      const bl = matrix[y2][x2];
      const tl = matrix[y2 + 1][x2];
...
function getAdjacentContour(contours, test, sort2) {
  let match = -1;
  for (let j = 0; j < contours.length; j++) {
    if (test(contours[j])) {
      if (match === -1 || sort2(contours[match], contours[j]) > 0) {
        match = j;
      }
    }
  }
...
// node_modules/@turf/isolines/dist/esm/index.js
    ...
    coordinates.forEach((line2) => {
      for (let i = 0; i < line1.length - 1; i++) {
        for (let k = i; k < line2.length - 1; k++) {
          ...
          const intersection4 = lineIntersects(
            line1[i][0],
            line1[i][1],
            line1[i + 1][0],
            line1[i + 1][1],
          ...
          if (intersection4) {
            results.features.push(point([intersection4[0], intersection4[1]]));
          }
        }
      }
    });
...
// node_modules/@turf/line-arc/dist/esm/index.js
...
// node_modules/@turf/line-chunk/dist/esm/index.js
function lineChunk(geojson, segmentLength, options = {}) {
  if (!isObject(options)) throw new Error("options is invalid");
  const { units = "kilometers", reverse: reverse2 = false } = options;
  if (!geojson) throw new Error("geojson is required");
  if (segmentLength <= 0) {
...
// node_modules/@turf/line-offset/dist/esm/index.js
...
function intersection3(a, b) {
  if (isParallel2(a, b)) return false;
  ...
  coords.forEach(function(currentCoords, index) {
    if (index !== coords.length - 1) {
      ...
      if (index > 0) {
        ...
        var intersects2 = intersection3(segment, seg2Coords);
...
// node_modules/@turf/line-slice/dist/esm/index.js
...
function fixSegmentIndexBounds(line, vertex) {
  let geometry2 = line.type === "Feature" ? line.geometry : line;
  if (vertex.properties.segmentIndex >= geometry2.coordinates.length - 1) {
    vertex.properties.segmentIndex = geometry2.coordinates.length - 2;
  }
}
...
// node_modules/@turf/mask/dist/esm/index.js
function mask(polygon2, mask2, options) {
  var _a2;
  const mutate = (_a2 = options == null ? void 0 : options.mutate) != null ? _a2 : false;
  ...
  if (polygon2.type === "FeatureCollection") {
    ...
    polygonOuters = createGeomFromPolygonClippingOutput(
      union(polygon2.geometry.coordinates)
    );
  } else {
    polygonOuters = createGeomFromPolygonClippingOutput(
      union(polygon2.coordinates)
    );
  }
...
function unionFc(fc) {
  const unioned = fc.features.length === 2 ? union(
...
// node_modules/@turf/moran-index/dist/esm/index.js
function moranIndex(fc, options) {
  ...
  const binary = (_a2 = options.binary) != null ? _a2 : false;
  const alpha = options.alpha || -1;
  const standardization = (_b2 = options.standardization) != null ? _b2 : true;
...
// node_modules/@turf/nearest-neighbor-analysis/dist/esm/index.js
function nearestNeighborAnalysis(dataset, options) {
  ...
  const observedMeanDistance = features.map((feature2, index) => {
...
// node_modules/@turf/point-to-line-distance/dist/esm/index.js
...
// node_modules/@turf/nearest-point-to-line/dist/esm/index.js
...
// node_modules/@turf/planepoint/dist/esm/index.js
...
// node_modules/@turf/points-within-polygon/dist/esm/index.js
...
// node_modules/@turf/point-to-polygon-distance/dist/esm/index.js
function pointToPolygonDistance(point2, polygonOrMultiPolygon, options = {}) {
  var _a2, _b2;
  const method = (_a2 = options.method) != null ? _a2 : "geodesic";
  const units = (_b2 = options.units) != null ? _b2 : "kilometers";
  ...
  if (geom.type === "MultiPolygon") {
    const distances = geom.coordinates.map(
      (coords) => pointToPolygonDistance(point2, polygon(coords), { method, units })
    );
    return Math.min(...distances.map(Math.abs)) * (booleanPointInPolygon(point2, polygonOrMultiPolygon) ? -1 : 1);
  }
  ...
  flattenEach(lines, (feature2) => {
    minDistance = Math.min(
      minDistance,
      pointToLineDistance(point2, feature2, {
        method,
        units
      })
    );
  });
  return booleanPointInPolygon(point2, geom) ? -minDistance : minDistance;
}

// node_modules/@turf/polygonize/dist/esm/index.js
...
// node_modules/@turf/polygon-smooth/dist/esm/index.js
...
// node_modules/@turf/polygon-tangents/dist/esm/index.js
...
// node_modules/@turf/quadrat-analysis/dist/esm/index.js
...
// node_modules/@turf/random/dist/esm/index.js
var esm_exports7 = {};
...
function rewind(geojson, options = {}) {
  ...
  if (!isObject(options)) throw new Error("options is invalid");
  const mutate = (_a2 = options.mutate) != null ? _a2 : false;
  const reverse2 = (_b2 = options.reverse) != null ? _b2 : false;
  if (!geojson) throw new Error("<geojson> is required");
...
// node_modules/@turf/sample/dist/esm/index.js
...
function getRandomSubarray(arr, size) {
  var shuffled = arr.slice(0), i = arr.length, min = i - size, temp2, index;
  while (i-- > min) {
    index = Math.floor((i + 1) * Math.random());
    temp2 = shuffled[index];
...
// node_modules/@turf/sector/dist/esm/index.js
...
// node_modules/@turf/transform-scale/dist/esm/index.js
...
// node_modules/@turf/shortest-path/dist/esm/index.js
...
var astar = {
  ...
  search: function(graph, start, end, options = {}) {
    ...
    graph.cleanDirty();
    options = options || {};
    var heuristic = astar.heuristics.manhattan, closest = (_a2 = options.closest) != null ? _a2 : false;
...
// node_modules/@turf/simplify/dist/esm/index.js
...
function simplifyDPStep(points2, first, last, sqTolerance, simplified) {
  ...
  for (var i = first + 1; i < last; i++) {
    var sqDist2 = getSqSegDist(points2[i], points2[first], points2[last]);
...
// node_modules/@turf/square/dist/esm/index.js
...
// node_modules/@turf/standard-deviational-ellipse/dist/esm/index.js
function standardDeviationalEllipse(points2, options) {
  ...
  featureEach(points2, function(point2) {
    var _a22;
    const weight = weightTerm ? ((_a22 = point2.properties) == null ? void 0 : _a22[weightTerm]) || 1 : 1;
  ...
  theEllipse.properties = (_a2 = theEllipse.properties) != null ? _a2 : {};
...
// node_modules/@turf/tag/dist/esm/index.js
...
// node_modules/@turf/tesselate/dist/esm/index.js
...
// node_modules/@turf/transform-translate/dist/esm/index.js
...
// node_modules/@turf/unkink-polygon/dist/esm/index.js
...
function isUnique(array2) {
  ...
  for (var i = 0, l = array2.length; i < l; ++i) {
    if (Object.prototype.hasOwnProperty.call(u4, array2[i].toString())) {
      isUnique2 = 0;
      break;
    }
    u4[array2[i].toString()] = 1;
  }
  return isUnique2;
}
...
function clipEdges(x02, y02, x12, y12) {
  ...
  while (i--) {
    if (!connectEdge(edge = edges[i], x02, y02, x12, y12) || !clipEdge(edge, x02, y02, x12, y12) || !(Math.abs(edge[0][0] - edge[1][0]) > epsilon3 || Math.abs(edge[0][1] - edge[1][1]) > epsilon3)) {
      delete edges[i];
    }
  }
}
...
function sortCellHalfedges() {
  for (var i = 0, n = cells.length, cell, halfedges, j, m; i < n; ++i) {
    if ((cell = cells[i]) && (m = (halfedges = cell.halfedges).length)) {
      ...
      for (j = 0; j < m; ++j) index[j] = j, array2[j] = cellHalfedgeAngle(cell, edges[halfedges[j]]);
      index.sort(function(i2, j2) {
        return array2[j2] - array2[i2];
      });
      for (j = 0; j < m; ++j) array2[j] = halfedges[index[j]];
      ...
      while (iHalfedge < nHalfedges) {
        ...
        if (Math.abs(endX - startX) > epsilon3 || Math.abs(endY - startY) > epsilon3) {
          halfedges.splice(iHalfedge, 0, edges.push(createBorderEdge(
            ...
            Math.abs(endX - x02) < epsilon3 && y12 - endY > epsilon3 ? [x02, Math.abs(startX - x02) < epsilon3 ? startY : y12] : Math.abs(endY - y12) < epsilon3 && x12 - endX > epsilon3 ? [Math.abs(startY - y12) < epsilon3 ? startX : x12, y12] : Math.abs(endX - x12) < epsilon3 && endY - y02 > epsilon3 ? [x12, Math.abs(startX - x12) < epsilon3 ? startY : y02] : Math.abs(endY - y02) < epsilon3 && endX - x02 > epsilon3 ? [Math.abs(startY - y02) < epsilon3 ? startX : x02, y02] : null
          )) - 1);
          ++nHalfedges;
        }
      }
...
function voronoi_default() {
  ...
  voronoi.x = function(_) {
    return arguments.length ? (x2 = typeof _ === "function" ? _ : constant_default4(+_), voronoi) : x2;
  };
  voronoi.y = function(_) {
    return arguments.length ? (y2 = typeof _ === "function" ? _ : constant_default4(+_), voronoi) : y2;
  };
...
// node_modules/@turf/voronoi/dist/esm/index.js
...
function voronoi2(points2, options) {
  ...
  return featureCollection(
    voronoi_default().x((feature2) => feature2.geometry.coordinates[0]).y((feature2) => feature2.geometry.coordinates[1]).extent([
      [bbox3[0], bbox3[1]],
      [bbox3[2], bbox3[3]]
    ]).polygons(points2.features).map(function(coords, index) {
      return Object.assign(coordsToPolygon(coords), {
        properties: cloneProperties(points2.features[index].properties)
      });
    })
  );
}
