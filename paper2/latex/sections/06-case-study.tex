...
\textbf{Models.}
Text-to-SQL evaluation (H4) uses the 201-sample held-out benchmark from the CIM Assist thesis~\cite{taherdoust2025cimassist}.
The same frozen SQLCoder-7B (QLoRA V3) adapter powers O5 \emph{source}-SQL generation in the VKG agents (not the thesis chat agent).
...
\input{tables/results_t6}
\input{tables/results_t7}
