...
\begin{itemize}[leftmargin=*]
  \item A taxonomy-structured CIM benchmark with 88K pairs and 99\%+ gold executability supports reproducible text-to-SQL evaluation (H3).
  \item Fine-tuned SQLCoder-7B reaches 84.6\% EX/EA, outperforming frontier models by $>$50 percentage points (H4).
