...
Domain fine-tuning improves execution accuracy (EX) over frontier models on specialised SQL.
We adopt LoRA fine-tuning of Qwen~2.5 and Llama~3.1 code models and evaluate with EM, EX, Deep EM, semantic correctness (SC), and eventual accuracy (EA) after agentic repair~\cite{xiao2025llm4vkg}.
